...
//             >
//               <div className="bg-gradient-to-r from-black/60 via-black/40 to-black/60 w-full h-full flex items-center justify-center">
//                 <div className="text-center text-white px-4">
//                   <h1 className="text-4xl md:text-5xl font-bold mb-4 text-green-400 drop-shadow-lg">
//                     {slide.title}
//                   </h1>
            ...
            >
              <div className="w-full h-full bg-gradient-to-r from-black/70 via-black/50 to-black/70 flex items-center justify-center px-4 md:px-10">
                <div className="max-w-3xl text-center text-white space-y-6">
                  ...
                  <button className="mt-4 bg-green-500 hover:bg-green-600 text-white font-semibold px-6 py-3 rounded-full shadow-lg transition duration-300">
                    Get Started
                  </button>
                </div>
              </div>
